...
function getDraftSecret() {
	return "39867ba4-09ab-4db1-b4ed-9cf74ded82a4";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "1bb1e852-f2d5-45b2-a1be-46515e587bb0";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "1bb1e852-f2d5-45b2-a1be-46515e587bb0") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "1bb1e852-f2d5-45b2-a1be-46515e587bb0",
		rootBoundaryId
	});
}
/**
